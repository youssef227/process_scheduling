...
String processCount = "";
String timeQuantum = "";
List arrivalTime = List.filled(int.parse(processCount), 0);
List burstTime = List.filled(int.parse(processCount), 0);
List priority = List.filled(int.parse(processCount), 0);
